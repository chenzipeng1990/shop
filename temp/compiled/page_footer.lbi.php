...
?> 
    ...
    <h4 class="f_links">底部导航：</h4>
      ...
      <li>
            ...
            <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_58427300_1441161320');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_58427300_1441161320']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?> 
            <a href="<?php echo $this->_var['nav_0_58427300_1441161320']['url']; ?>" <?php if ($this->_var['nav_0_58427300_1441161320']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_58427300_1441161320']['name']; ?></a> 
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
            <?php endif; ?> 
          </li>
          </ul>
