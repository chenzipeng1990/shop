...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;margin-top:0px;margin-left:50px;"><img src="images/topLogo.png" style="height: 80px;"/></div>
  ...
  <div id="submenu-div">
    ...
    <li><a href="privilege.php?act=logout" target="main-frame"><img src="images/topmune_08.png" style="border:none;"/><span><?php echo $this->_var['lang']['signout']; ?></span></a></li>
     <li><a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu"><img src="images/qingchu.png" style="border:none;"/><span><?php echo $this->_var['lang']['clear_cache']; ?></span></a></li>
      ...
      <li style="border-left:none;"><a href="index.php?act=first" target="main-frame"><img src="images/topmune_01.png" style="border:none;"/><span><?php echo $this->_var['lang']['shop_guide']; ?></span></a></li>
    </ul>
